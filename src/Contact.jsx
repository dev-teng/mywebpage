  ...
  return (
    <div className="d-flex flex-column min-vh-100 contactBackground">
      <div className="row g-0 m-5">
          ...
          <div className="col-6 g-2 col-md-3 mt-auto mt-5">
          ...
          <div className="col-6 g-2 col-md-3 mt-5">
            <div className="card hover-bounce">
              <div className="card-body text-center">
          ...
          <div className="col-6 g-2 col-md-3 offset-md-6 mt-2">
            <div className="card hover-bounce">
              <div className="card-body text-center">
          ...
          <div className="col-6 g-2 col-md-3 mt-2">
            <div className="card hover-bounce">
              <div className="card-body text-center">
